...
const file_protos_auth_proto_rawDesc = "" +
	"\n" +
	"\x11protos/auth.proto\x12\x04auth\x1a\x1fgoogle/protobuf/timestamp.proto\"@\n" +
	...
	"\n" +
	"created_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt2\xf7\x01\n" +
	"\vAuthService\x120\n" +
	...
	"\fRefreshToken\x12\x14.auth.RefreshRequest\x1a\x15.auth.RefreshResponse\x12>\n" +
	"\rValidateToken\x12\x15.auth.ValidateRequest\x1a\x16.auth.ValidateResponseB\aZ\x05/authb\x06proto3"
...
var file_protos_auth_proto_depIdxs = []int32{
	...
	9, // 1: auth.RefreshResponse.expires_at:type_name -> google.protobuf.Timestamp
	9, // 2: auth.User.created_at:type_name -> google.protobuf.Timestamp
	...
	7, // 10: auth.AuthService.ValidateToken:output_type -> auth.ValidateResponse
