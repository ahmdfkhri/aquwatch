...
class LoginResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set expiresAt($2.Timestamp v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class RefreshResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set expiresAt($2.Timestamp v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class ValidateRequest extends $pb.GeneratedMessage {
  ...
  ValidateRequest._() : super();
  factory ValidateRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ValidateRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidateRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'accessToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ValidateRequest clone() => ValidateRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValidateRequest copyWith(void Function(ValidateRequest) updates) => super.copyWith((message) => updates(message as ValidateRequest)) as ValidateRequest;
  ...
  static $pb.PbList<ValidateRequest> createRepeated() => $pb.PbList<ValidateRequest>();
  @$core.pragma('dart2js:noInline')
  static ValidateRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ValidateRequest>(create);
...
class ValidateResponse extends $pb.GeneratedMessage {
  ...
  ValidateResponse._() : super();
  factory ValidateResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ValidateResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ValidateResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'userId')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ValidateResponse clone() => ValidateResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValidateResponse copyWith(void Function(ValidateResponse) updates) => super.copyWith((message) => updates(message as ValidateResponse)) as ValidateResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ValidateResponse create() => ValidateResponse._();
  ValidateResponse createEmptyInstance() => create();
  static $pb.PbList<ValidateResponse> createRepeated() => $pb.PbList<ValidateResponse>();
  @$core.pragma('dart2js:noInline')
  static ValidateResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ValidateResponse>(create);
  static ValidateResponse? _defaultInstance;
...
class User extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set createdAt($2.Timestamp v) { $_setField(4, v); }
  @$pb.TagNumber(4)
