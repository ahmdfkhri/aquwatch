...
class Api extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Api', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$5.Option>(3, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $5.Option.create)
    ...
    ..e<$5.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $5.Syntax.SYNTAX_PROTO2, valueOf: $5.Syntax.valueOf, enumValues: $5.Syntax.values)
  ...
  @$pb.TagNumber(3)
  $pb.PbList<$5.Option> get options => $_getList(2);
  ...
  @$pb.TagNumber(5)
  set sourceContext($3.SourceContext v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set syntax($5.Syntax v) { $_setField(7, v); }
  @$pb.TagNumber(7)
...
class Method extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Method', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$5.Option>(6, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $5.Option.create)
    ..e<$5.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $5.Syntax.SYNTAX_PROTO2, valueOf: $5.Syntax.valueOf, enumValues: $5.Syntax.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $pb.PbList<$5.Option> get options => $_getList(5);
